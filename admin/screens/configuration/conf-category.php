...
if ( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
	...
	if ( ! isset( $cat_id ) ) {
		...
		$Insert_Query = "INSERT INTO category (cat_name, status)
		...
		// update
		$Update_Query = "Update category SET cat_name = '$catname', status = '$status' where cat_id = '$cat_id'";
...
if ( isset( $_GET['cat_id'] ) ) {
	...
	$category_Get_Query = "SELECT * FROM category where cat_id= $cat_id";
